...
(custom-set-variables
 ...
 '(package-selected-packages
   '(consult youdao-dictionary which-key vertico use-package-ensure-system-package treemacs-all-the-icons toc-org texfrag smartparens shackle rust-mode rime restart-emacs rainbow-delimiters quelpa-use-package pyvenv-auto popper plantuml-mode ox-hugo org-roam-ui org-noter org-modern org-download org-contrib org-auto-tangle org-appear org-ai orderless ob-rust no-littering multiple-cursors minions marginalia magit-delta lua-mode lsp-ui lsp-treemacs keycast helpful greader good-scroll gnuplot fontaine flycheck eshell-up eshell-syntax-highlighting eshell-git-prompt esh-autosuggest elpy eglot ef-themes doom-modeline diredfl diminish diff-hl dashboard crux counsel corfu company-anaconda cdlatex cargo cape blacken auto-package-update aproject amx all-the-icons-ivy-rich all-the-icons-dired all-the-icons-completion ace-pinyin)))
(custom-set-faces
